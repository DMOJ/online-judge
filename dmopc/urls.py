...
urlpatterns = patterns('',
    ...
    url(r'^[user|u]/(\w+)$', 'judge.views.user'),
    url(r'^[user|u]$', 'judge.views.user'),
    ...
    url(r'^[problem|p]/(?P<code>\w+)$', problem.ProblemDetail.as_view(), name='problem_detail'),
    url(r'^[problem|p]/(?P<code>\w+)/pdf$', problem.ProblemPdfView.as_view(), name='problem_pdf'),
    url(r'^[problem|p]/(?P<code>\w+)/latex$', problem.ProblemLatexView.as_view(), name='problem_latex'),
    url(r'^[problem|p]/(?P<code>\w+)/edit', problem.ProblemEdit.as_view(), name='problem_edit'),
    url(r'^[problem|p]/(\w+)/submit$', 'judge.views.problem_submit'),
    url(r'^[problem|p]/(\w+)/resubmit/(\d+)$', 'judge.views.problem_submit'),
    ...
    url(r'^[submission|s]/(?P<pk>\d+)$', views.SubmissionStatus.as_view(), name='submission_status'),
    url(r'^[submission|s]/(\d+)/abort$', 'judge.views.abort_submission'),
    url(r'^[submission|s]/(\d+)/html$', 'judge.views.single_submission'),
    ...
    url(r'^[problem|p]/(?P<problem>\w+)/rank/$', views.RankedSubmissions.as_view(), name='ranked_submissions'),
    url(r'^[problem|p]/(?P<problem>\w+)/rank/(?P<page>\d+)$', views.RankedSubmissions.as_view(), name='ranked_submissions'),
    url(r'^[problem|p]/(?P<problem>\w+)/submissions/$', views.ProblemSubmissions.as_view(), name='chronological_submissions'),
    url(r'^[problem|p]/(?P<problem>\w+)/submissions/(?P<page>\d+)$', views.ProblemSubmissions.as_view(), name='chronological_submissions'),

    url(r'^[problem|p]/(?P<problem>\w+)/submissions/(?P<user>\w+)/$', views.UserProblemSubmissions.as_view(), name='user_submissions'),
    url(r'^[problem|p]/(?P<problem>\w+)/submissions/(?P<user>\w+)/(?P<page>\d+)$', views.UserProblemSubmissions.as_view(), name='user_submissions'),

    url(r'^[user|u]/(?P<user>\w+)/submissions/$', views.AllUserSubmissions.as_view(), name='all_user_submissions'),
    url(r'^[user|u]/(?P<user>\w+)/submissions/(?P<page>\d+)$', views.AllUserSubmissions.as_view(), name='all_user_submissions'),
    ...
    url(r'^[contest|c]/(?P<key>\w+)$', views.ContestDetail.as_view(), name='contest_view'),
    url(r'^[contest|c]/(\w+)/ranking/$', 'judge.views.contest_ranking'),
    url(r'^[contest|c]/(\w+)/ranking/ajax$', 'judge.views.contest_ranking_ajax'),
    url(r'^[contest|c]/(\w+)/join$', 'judge.views.join_contest'),
    url(r'^[contest|c]/(\w+)/leave$', 'judge.views.leave_contest'),

    url(r'^[contest|c]/(?P<contest>\w+)/rank/(?P<problem>\w+)/$', views.ContestRankedSubmission.as_view(), name='contest_ranked_submissions'),
    url(r'^[contest|c]/(?P<contest>\w+)/rank/(?P<problem>\w+)/(?P<page>\d+)$', views.ContestRankedSubmission.as_view(), name='contest_ranked_submissions'),

    url(r'^[contest|c]/(?P<contest>\w+)/submissions/(?P<user>\w+)/(?P<problem>\w+)/$', views.UserContestSubmissions.as_view(), name='contest_user_submissions'),
    url(r'^[contest|c]/(?P<contest>\w+)/submissions/(?P<user>\w+)/(?P<problem>\w+)/(?P<page>\d+)$', views.UserContestSubmissions.as_view(), name='contest_user_submissions'),
    ...
    url(r'^[organization|o]/(?P<key>\w+)$', organization.OrganizationHome.as_view(), name='organization_home'),
    url(r'^[organization|o]/(?P<key>\w+)/users$', organization.OrganizationUsers.as_view(), name='organization_users'),
    url(r'^[organization|o]/(?P<key>\w+)/join', organization.JoinOrganization.as_view(), name='join_organization'),
    url(r'^[organization|o]/(?P<key>\w+)/leave', organization.LeaveOrganization.as_view(), name='leave_organization'),
    url(r'^[organization|o]/(?P<key>\w+)/edit', organization.EditOrganization.as_view(), name='edit_organization'),
