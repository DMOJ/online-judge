...
urlpatterns = patterns('',
    ...
    url(r'^src/(\d+)$', views.SubmissionSource.as_view(), name='submission_source'),
    url(r'^submission/(\w+)$', views.SubmissionStatus.as_view(), name='submission_status'),
    ...
    url(r'^contest/(\w+)$', 'judge.views.contest', name='contest_view'),
