...
urlpatterns = patterns('',
    ...
    url(r'^problem/(\w+)/rank/$', 'judge.views.problem_submissions', title='Best solutions for %s',
        order=['-points', '-time', '-memory']),
    url(r'^problem/(\w+)/submissions/$', 'judge.views.problem_submissions', title='Submissions for %s'),
)
