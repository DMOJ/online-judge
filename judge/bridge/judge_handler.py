...
class JudgeHandler(ZlibPacketHandler):
    ...
    def can_judge(self, problem, executor, judge_ids=()):
        return problem in self.problems and executor in self.executors and (not judge_ids or self.name in judge_ids)
