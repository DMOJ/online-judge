...
class JudgeHandler(ZlibPacketHandler):
    ...
    def can_judge(self, problem, executor, judge_names=()):
        return (
            problem in self.problems and executor in self.executors and (not judge_names or self.name in judge_names)
        )
