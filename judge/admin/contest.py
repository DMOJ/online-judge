...
class ContestForm(ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['see_contest_scoreboard'].widget.can_add_related = False
    ...
    class Meta:
        widgets = {
            ...
            'banned_users': AdminHeavySelect2MultipleWidget(data_view='profile_select2',
                                                            attrs={'style': 'width: 100%'}),
            'see_contest_scoreboard': AdminHeavySelect2MultipleWidget(data_view='profile_select2',
                                                                      attrs={'style': 'width: 100%'}),
        }
...
class ContestAdmin(VersionAdmin):
    fieldsets = (
        ...
        (_('Access'), {'fields': ('access_code', 'is_private', 'private_contestants', 'is_organization_private',
                                  'organizations', 'see_contest_scoreboard')}),
