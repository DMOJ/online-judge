...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='contest',
            name='format_config',
            field=jsonfield.fields.JSONField(blank=True, null=True, verbose_name='contest format configuration'),
        ),
        migrations.AddField(
            model_name='contest',
            name='format_name',
            field=models.CharField(default=b'default', max_length=32, verbose_name='contest format'),
        ),
        migrations.AddField(
