    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'rate_all',
                    models.BooleanField(default=False, help_text='Rate all users who joined.', verbose_name='rate all'),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'format_data',
                    jsonfield.fields.JSONField(blank=True, null=True, verbose_name='contest format specific data'),
                ),
                (
                    'contest',
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.IntegerField(blank=True, null=True, verbose_name='output prefix length override'),
                ),
                (
                    'max_submissions',
                    models.IntegerField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'icon',
                    models.CharField(blank=True, help_text='URL to the icon', max_length=256, verbose_name='icon'),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.BooleanField(default=False, verbose_name='private to organizations'),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'type',
                    models.CharField(
                        choices=[('C', 'Normal case'), ('S', 'Batch start'), ('E', 'Batch end')],
                        default='C',
                        max_length=1,
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            ...
                            ('Chile', [('Chile/Continental', 'Continental'), ('Chile/EasterIsland', 'EasterIsland')]),
                            (
                                'Etc',
                                [
                ...
                (
                    'last_access',
                    models.DateTimeField(default=django.utils.timezone.now, verbose_name='last access time'),
                ),
