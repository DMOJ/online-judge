# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-04-22 19:50
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('page', models.CharField(db_index=True, help_text='c:contest_code, p:problem_code, s:problem_solution_id, or b:blog_id', max_length=30, validators=[django.core.validators.RegexValidator('^[pcs]:[a-z0-9]+$|^b:\\d+$', 'Page code must be ^[pcs]:[a-z0-9]+$|^b:\\d+$')], verbose_name='associated page')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_virtualable', models.BooleanField(default=True, help_text='Whether a user can virtually participate in this contest or not.', verbose_name='virtualable')),
                ('is_rated', models.BooleanField(default=False, help_text='Whether this contest can be rated.', verbose_name='contest rated')),
                ('require_registration', models.BooleanField(default=False, help_text='Whether the user must be registered before being able to join the contest.', verbose_name='require registration')),
                ('registration_page', models.TextField(blank=True, help_text='Flatpage to display when registering. Use name="" for form identifiers that will be stored in the registrations.', null=True, verbose_name='registration page')),
                ('registration_start_time', models.DateTimeField(blank=True, help_text='Allow registration starting at the specified time.', null=True, verbose_name='registration start time')),
                ('registration_end_time', models.DateTimeField(blank=True, help_text='Allow registration until the specified time.', null=True, verbose_name='registration end time')),
                ...
                ('is_private', models.BooleanField(default=False, help_text='Whether only specified organizations can view and join this contest.', verbose_name='completely private to organizations')),
                ...
                ('format_name', models.CharField(choices=[('bonuses', 'Bonuses'), ('default', 'Default')], default='default', help_text='The contest format module to use.', max_length=32, verbose_name='contest format')),
            ...
            options={
                ...
                'permissions': (('see_private_contest', 'See private contests'), ('join_all_contest', 'Join all contests'), ('edit_own_contest', 'Edit own contests'), ('edit_all_contest', 'Edit all contests'), ('clone_contest', 'Clone contest'), ('contest_frozen_state', 'Change contest frozen state'), ('contest_rating', 'Rate contests'), ('contest_access_code', 'Contest access codes')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.TextField(blank=True, null=True, verbose_name='user registration data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_frozen', models.BooleanField(default=False, help_text='Whether this submission was rejudged/rescored while the contest was frozen.', verbose_name='updated while frozen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_restricted', models.BooleanField(db_index=True, default=False, help_text='Whether to restrict access to the problem, and require special permissions. Set for contest problems, such as LCC problems.', verbose_name='restricted')),
            ...
            options={
                ...
                'permissions': (('see_private_problem', 'See hidden problems'), ('see_restricted_problem', 'See restricted problems'), ('edit_own_problem', 'Edit own problems'), ('edit_all_problem', 'Edit all problems'), ('edit_public_problem', 'Edit all public problems'), ('clone_problem', 'Clone problem'), ('change_public_visibility', 'Change is_public field'), ('change_restricted_field', 'Change is_restricted field'), ('change_manually_managed', 'Change is_manually_managed field'), ('see_organization_problem', 'See organization-private problems')),
            },
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_rank', models.CharField(choices=[('user', 'Normal User'), ('exec', 'Exec'), ('president', 'President'), ('alumnus', 'Alumnus'), ('setter', 'Problem Setter'), ('teacher', 'Teacher'), ('admin', 'Admin')], default='user', max_length=10, verbose_name='display rank')),
                ...
                ('api_token', judge.models.profile.EncryptedNullCharField(blank=True, help_text='32 character base32-encoded key for API access', max_length=32, null=True, validators=[django.core.validators.RegexValidator('^$|^[A-Z2-7]{32}$', 'API token must be empty or base32')], verbose_name='API token')),
                ('is_contest_account', models.BooleanField(default=False, help_text='If set, restricts this account to only contest features.', verbose_name='Contest account')),
            ...
            options={
                ...
                'permissions': (('test_site', 'Shows in-progress development stuff'), ('totp', 'Edit TOTP settings'), ('view_name', "View user's real name")),
            },
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            ...
            name='user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contest_registrations', to='judge.Profile', verbose_name='registrant'),
        ),
        migrations.AddField(
