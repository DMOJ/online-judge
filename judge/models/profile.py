...
class Profile(models.Model):
    ...
    api_token = CharField(max_length=32, null=True, blank=True, verbose_name=_('API token'),
                          help_text=_('32 character base32-encoded API access token'),
                          validators=[RegexValidator('^$|^[a-z2-9]{32}$', _('API token must be empty or base32'))])
