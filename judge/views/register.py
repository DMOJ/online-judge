...
class RegistrationView(OldRegistrationView):
    ...
    def register(self, form):
        ...
        profile, _ = Profile.objects.get_or_create(user=user, defaults={'language': Language.get_default_language()})
...
def social_auth_error(request):
    return render(
        ...
        {'title': gettext('Authentication failure'), 'message': request.GET.get('message')},
    )
