...
register_patterns = [
    url(
        ...
        TitledTemplateView.as_view(
            template_name='registration/activation_complete.html', title='Activation Successful!'
        ),
    ...
    url(r'^register/$', RegistrationView.as_view(title='Register'), name='registration_register'),
    url(
        r'^register/complete/$',
        TitledTemplateView.as_view(
            template_name='registration/registration_complete.html', title='Registration Completed'
        ),
    ...
    url(
        r'^register/closed/$',
        TitledTemplateView.as_view(
            template_name='registration/registration_closed.html', title='Registration not allowed'
        ),
...
def paged_list_view(view, name):
    return include([url(r'^$', view.as_view(), name=name), url(r'^(?P<page>\d+)$', view.as_view(), name=name)])
    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^/$', lambda _, problem: HttpResponsePermanentRedirect(reverse('problem_detail', args=[problem]))
                ),
    ...
    url(
        ...
        include(
            [
                ...
                url(
                    r'^/participations$', contests.ContestParticipationList.as_view(), name='contest_participation_own'
                ),
                url(
                ...
                url(
                    ...
                    include(
                        [
                            ...
                            url(
                                r'^approved$',
                                organization.OrganizationRequestLog.as_view(states=('A',), tab='approved'),
                ...
                url(
                    ...
                    include(
                        [
                            ...
                            url(
                                r'^ticket_assignee$', AssigneeSelect2View.as_view(), name='ticket_assignee_select2_ajax'
                            ),
                        ]
                    ),
                ),
    ...
    url(
        ...
        sitemap,
        {
            'sitemaps': {
                ...
                'pages': UrlSitemap([{'location': '/about/', 'priority': 0.9}]),
            }
        },
    ),
    url(
...
for favicon in favicon_paths:
    urlpatterns.append(url(r'^%s$' % favicon, RedirectView.as_view(url=lazystr(lambda: static('icons/' + favicon)))))
